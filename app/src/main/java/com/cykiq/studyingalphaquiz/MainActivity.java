...
//                new GetQuestion(0, "10", 99, new GetQuestion.OnPostExecuteListener() {
//                    @Override
//                    public void onTaskDOne(List<Question> questionList) {
//                        for(int i=0; i<questionList.size();i++){
//                            ((TextView)findViewById(R.id.text_view)).append(questionList.get(i).toString());
//                        }
//
//                    }
//                }).execute("");
        ...
        ((ProgressBar)findViewById(R.id.progress_bar_main)).setVisibility(View.VISIBLE);
        showStartTest();
    ...
    private void showStartTest() {

        final ChipCloud chipCloud = (ChipCloud) findViewById(R.id.chip_cloud_topics);
            ...
            public void onTaskDOne(boolean status, List<Topic> topicList) {
                try{
                    if(status){
                        ...
                        ((ProgressBar)findViewById(R.id.progress_bar_main)).setVisibility(View.GONE);
